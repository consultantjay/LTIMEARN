...
app.get('/rating_mmt/:rating',function(req,res){
...
app.get('/name_city_mmt/:name/:city',function(req,res){
...
app.get('/name_rating_mmt/:name/:rating',function(req,res){
...
app.get('/city_rating_mmt/:city/:rating',function(req,res){
  
      db.trip.aggregate([{$match:{$and:[{city:req.params.city},{hotel_star_rating:parseInt(req.params.rating)}]}},{$project:{area:1,property_name:1,_id:0,city:1}},{$sort:{mmt_tripadvisor_count:-1}}],function(err,docs){
                                          res.json(docs);
                                                }
                       );  
});   
...
app.get('/city_rating_name_mmt/:city/:rating/:name',function(req,res){
