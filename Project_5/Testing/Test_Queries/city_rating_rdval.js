...
db.hotel.aggregate([{$match:{$and:[{"city":"manali"},{"hotel_star_rating":{$gte:2}}]}},
...
it('by city_rating_rdval',function(){
const result = count;
expect(result).to.equal("Nirankari Group Of Hotels The Mall");
});
});
