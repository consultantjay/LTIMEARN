...
var typeOfProduct
var productName
describe('9. filter by price range sort by price  ascending',function(){
  ...
  it('Value  : product name should be equal to Chelsea',function(){
		const result = productName.split(" ")[0]
		expect(result).to.equal("Chelsea")
	})
