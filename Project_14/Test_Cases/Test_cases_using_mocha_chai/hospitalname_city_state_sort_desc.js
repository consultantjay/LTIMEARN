...
describe('Test by hospital name, city and state',function(){
	...
	before(function(done){
			...
			db.hospital.aggregate([{$match:{"Hospital Name":"DALE MEDICAL CENTER",City:"OZARK",State:"AL","Hospital overall rating":{$ne:"Not Available"}}},{$sort:{"Hospital overall rating":-1}}],function(err,res){
