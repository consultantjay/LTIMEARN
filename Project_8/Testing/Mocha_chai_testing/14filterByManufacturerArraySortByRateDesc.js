...
var typeOfProduct
var productName
describe('14. filter by manufacturer array sort by rates descending',function(){
  ...
  it('Value  : product name should be equal to Kato',function(){
		const result = productName.split(" ")[0]
		expect(result).to.equal("Kato")
	})
